...
trajectory in simulation. Review command frequency, maximum joint step, and
acceleration together; changing only one can create a new bottleneck. Do not
increase limits during an unexplained mechanical or communication fault.
